...
const Getevaluationnoncadre = () => {
    ...
    const getAlldataevaluation = async () => {
        try {
            const response = await axios.get(`${url}getAlldataevaluation/${id}/${type}`);
    ...
    const enregistrement = async () => {
        try {
            const enrg = await axios.post(`${url}enregistrement/${id}`, {
                ...
                mt1,
                mt2,
                mt3, ml1, ml2, ml3, cpr1, cpr2, cpr3, cg1, cg2, cg3, comcollab, objectifs1, resultat1, somme, todayis
            });
            next()
        } catch (error) {
            console.log(error);
...
export default Getevaluationnoncadre; 
