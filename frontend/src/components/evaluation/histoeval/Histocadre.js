...
import { Button, message, Steps, Checkbox, notification, AutoComplete } from 'antd';
...
const Histocadre = () => {
    ...
    // const loggedInUser ="boucher.edouard@npakadin.mg"
    ...
    const etape1 = (placement) => {
        ...
        if (nom == '') {
            ...
            //     notification.info({
            //         message: `Notification`,
            //         description: "Vérifiez l'adresse mail de votre évaluateur N+2.",
            //         placement,
            //     });
            //     return;
            // }
            ...
            // else if (!emails.includes(emailn2)) {
            //     notification.info({
            //         message: `Notification`,
