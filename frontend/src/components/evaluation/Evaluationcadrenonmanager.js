...
import { Button, message, Steps, Checkbox, notification, Space } from 'antd';
...
const Evaluationcadrenonmanager = () => {
    ...
    const getAlldataevaluationnonmanager = async () => {
        const type = 'Evaluation cadre non manager'
        try {
            const response = await axios.get(`${url}getAlldataevaluationcadrenonmanager/${ids}/${type}`);
    ...
    const etape1 = (placement) => {
        if (nom == '') {
            ...
            notification.error({
                message: `Erreur`,
                description: "e-mail N+1 ne doit pas être vide.",
                placement,
            });
            return;
            // } else if (nomeval == '') {
                    ...
                    <table style={{ margin: 'auto', textAlign: 'center', borderCollapse: 'collapse', width: '80%' }}>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style={{ padding: '10px', border: '1px solid #40A9FF' }}>Capacité à montrer l'exemple, capacité à faire adhérer à une chose, respect des règles</td>
                            ...
                            <tr>
                                ...
                                <td style={{ padding: '10px', border: '1px solid #40A9FF' }}>Capacité à gérer et conduire un changement</td>
...
export default Evaluationcadrenonmanager; // Assurez-vous que cette ligne est présente pour exporter le composant Evaluationcadrenonmanager
