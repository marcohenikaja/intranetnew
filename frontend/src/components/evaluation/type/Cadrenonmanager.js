...
const Cadrenonmanager = () => {
    ...
    const etape1 = (placement) => {
        if (nom == '') {
            ...
            notification.error({
                message: `Erreur`,
                description: "e-mail N+2 ou e-mail directeur de rattachement vide.",
                placement,
            });
            return;
        } else if (mat == '') {
...
export default Cadrenonmanager; // Assurez-vous que cette ligne est présente pour exporter le composant Cadrenonmanager
